                  ...
                  <div className="mt-3 space-y-2">
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-700">
                        <span className="font-semibold">Designation:</span> Design Director
                      </p>
                    </div>
                    <div className="flex items-center">
                      <span className="text-blue-600 mr-2">
                ...
                <div className="text-center sm:text-left flex-1">
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-700">
                        <span className="font-semibold">Designation:</span> Lead Developer
                      </p>
                    </div>
                    <div className="flex items-center">
                      <span className="text-purple-600 mr-2">
                      ...
                      <p className="text-gray-700">
                        <span className="font-semibold">Department:</span> Electronics
                      </p>
                    </div>
                    <div className="flex items-center">
                      <span className="text-purple-600 mr-2">
                      ...
                      <p className="text-gray-700">
                        <span className="font-semibold">Other Roles:</span> Alumni Coordinator
                      </p>
                    </div>
                    <div className="flex items-center">
                      <span className="text-purple-600 mr-2">
