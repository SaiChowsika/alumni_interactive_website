        ...
        <div className="flex items-center justify-between mx-auto max-w-7xl px-2 py-1.5">
          ...
          <div className="hidden md:flex md:justify-center md:flex-1">
            <div className="flex space-x-19">
              ...
              <Link to="/sessions" className="text-white hover:text-black cursor-pointer">Sessions</Link>
              <Link to="/placements" className="text-white hover:text-black cursor-pointer">Placements</Link>
        ...
        {!isMobileMenuClosedByToggle && (
          ...
          >
            <div className="flex flex-col space-y-2 ">
              ...
              <Link to="/sessions" className="text-white hover:text-primary hover:text-blue-600 cursor-pointer">Sessions</Link>
              <Link to="/placements" className="text-white hover:text-primary hover:text-blue-600 cursor-pointer">Placements</Link>
